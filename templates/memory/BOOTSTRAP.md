...
Read `Memory/USER.md` and `Memory/SOUL.md` first. If the user already partially filled in some fields (from a previous incomplete session or manual editing), **skip those questions** and only ask about what's still placeholder.
...
5. **Delete this file** — Use Bash to run: `rm "Memory/BOOTSTRAP.md"`
